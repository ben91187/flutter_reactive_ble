...
final $typed_data.Uint8List getConnectionRequestDescriptor = $convert.base64Decode('ChRHZXRDb25uZWN0aW9uUmVxdWVzdBIaCghkZXZpY2VJZBgBIAEoCVIIZGV2aWNlSWQ=');
@$core.Deprecated('Use getConnectionInfoDescriptor instead')
const GetConnectionInfo$json = const {
  '1': 'GetConnectionInfo',
  '2': const [
...
final $typed_data.Uint8List getConnectionInfoDescriptor = $convert.base64Decode('ChFHZXRDb25uZWN0aW9uSW5mbxIUCgVzdGF0ZRgBIAEoCFIFc3RhdGU=');
@$core.Deprecated('Use btMacAddressInfoDescriptor instead')
const BtMacAddressInfo$json = const {
  '1': 'BtMacAddressInfo',
  '2': const [
    const {'1': 'deviceId', '3': 1, '4': 1, '5': 9, '10': 'deviceId'},
  ],
...
final $typed_data.Uint8List btMacAddressInfoDescriptor = $convert.base64Decode('ChBCdE1hY0FkZHJlc3NJbmZvEhoKCGRldmljZUlkGAEgASgJUghkZXZpY2VJZA==');
